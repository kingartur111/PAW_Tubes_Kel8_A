  ...
  <v-card>
      <v-img 
        ...
        >
            ...
            <v-card-text
              style="margin-top: 10%;background: rgba(0, 0, 0, 0);color:white;font-size:30px;text-align: center;font-family: Redressed;font-style: normal;font-weight: normal;"  
              >"I have always imagined that Paradise will be a kind of a Library."</v-card-text>
              
            <v-card-text
              style="background: rgba(0, 0, 0, 0);color:white;font-size:20px;text-align: center;"  
              >Jorge Luis Borges</v-card-text>
              <v-card-text
              style="background: rgba(0, 0, 0, 0);color:white;font-size:15px;text-align: center;"  
